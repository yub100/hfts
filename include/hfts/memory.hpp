#ifndef hfts_memory_h
#define hfts_memory_h
...
struct Allocation {
  ...
  enum class Usage : uint8_t {
    ...
    Vector,  // hfts::containers::vector<T>
    List,    // hfts::containers::list<T>
    Stl,     // hfts::StlAllocator
...
// hfts provides a default implementation with Allocator::Default.
class Allocator {
 public:
...
// StlAllocator exposes an STL-compatible allocator wrapping a hfts::Allocator.
template <typename T>
struct StlAllocator {
  using value_type = T;
  using pointer = T*;
